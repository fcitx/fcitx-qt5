 ...
 * Command line was: qdbusxml2cpp -N -p fcitxqtkeyboardproxy -c FcitxQtKeyboardProxy interfaces/org.fcitx.Fcitx.Keyboard.xml -i fcitxqtkeyboardlayout.h -i fcitxqtdbusaddons_export.h
 *
...
public Q_SLOTS: // METHODS
    inline QDBusPendingReply<QString, QString> GetLayoutForIM(const QString &im)
    {
        ...
        return asyncCallWithArgumentList(QStringLiteral("GetLayoutForIM"), argumentList);
    }
    inline QDBusReply<QString> GetLayoutForIM(const QString &im, QString &variant)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(im);
        QDBusMessage reply = callWithArgumentList(QDBus::Block, QStringLiteral("GetLayoutForIM"), argumentList);
    ...
    {
        QList<QVariant> argumentList;
        return asyncCallWithArgumentList(QStringLiteral("GetLayouts"), argumentList);
    }
    ...
    inline QDBusPendingReply<> SetLayoutForIM(const QString &im, const QString &layout, const QString &variant)
    {
        ...
        return asyncCallWithArgumentList(QStringLiteral("SetLayoutForIM"), argumentList);
    }
